...
MagAgent's durable execution runtime is the shared lifecycle contract for CLI,
daemon, orchestrated-goal, and desktop work. It is intentionally separate from the
older personal task list exposed by `magent task`.
